  ...
  <div class="admin-shell">
    ...
    <aside class="admin-sidebar" id="adminSidebar" aria-label="Main navigation">
      ...
      <div class="sidebar-user">
        <img class="avatar-img avatar-md sidebar-user-avatar" src="{{asset('dashboard_assets/images/avatar/avatar.jpg')}}" alt="Admin Hasan">
          ...
          <div class="navbar-actions ms-auto">
            ...
            <div class="dropdown">
              <button class="profile-button dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar.jpg')}}" alt="Admin Hasan">
              ...
              <table class="table align-middle mb-0">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar-1.jpg')}}" alt="Sarah Ahmed">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar-2.jpg')}}" alt="Rafi Khan">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar-3.jpg')}}" alt="Nadia Islam">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar-4.jpg')}}" alt="Mina Torres">
                        <div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex align-items-center gap-2">
                        <img class="avatar-img avatar-sm" src="{{asset('dashboard_assets/images/avatar/avatar-5.jpg')}}" alt="Jon Oliver">
                        <div>
